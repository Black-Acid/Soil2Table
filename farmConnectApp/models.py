...
class UserModel(models.Model):
    ...
    profile_image = models.ImageField(upload_to="profiles/", blank=True, null=True)  # ✅ Added Image Field
...
class FarmDetailsModel(models.Model):
    user = models.OneToOneField(UserModel, on_delete=models.CASCADE, limit_choices_to={'role': 'Farmer'})
